  ...
  <div class="container-fluid">
    <div class="py-3" id="main">
      <div class="box shadow bg-dark p-4 rounded-3">
            ...
            <div class="collapse" id="newFileCollapse" data-bs-parent="#tools" style="transition:none;">
              <form action="" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="newFileName" placeholder="221B.php">
                </div>
                <div class="mb-3">
        ...
        <div class="text-light">@221B <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script></div>
      </div>
    </div>
  </div>
  ...
  <?php endif; clear(); ?>
    function deleteConfirm(url) {
      ...
      Swal.fire({
          ...
          confirmButtonColor: '#434970',
          cancelButtonColor: '#821',
